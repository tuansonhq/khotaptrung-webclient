LazyLoad=function(instanceSettings){var _defaultSettings={elements_selector:"img",container:window,threshold:300,throttle:40,data_src:"original",data_srcset:"original-set",data_ignore:"ignore",class_loading:"loading_lazy",class_loaded:"loaded",skip_invisible:true,show_while_loading:false,callback_load:null,callback_set:null,callback_processed:null,placeholder:"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"},_supportsAddEventListener=!!window.addEventListener,_supportsAttachEvent=!!window.attachEvent,_supportsClassList=!!document.body.classList,_this=this,_previousLoopTime=0,_loopTimeout=null;function _addEventListener(element,eventName,callback){if(_supportsAddEventListener){element.addEventListener(eventName,callback);return;}
