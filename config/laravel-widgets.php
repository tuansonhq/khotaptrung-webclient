...
return [
    ...
    */
    'widget_stub'  => 'vendor/arrilot/laravel-widget/src/Console/stubs/widget.stub',

    /*
    * Relative path from the base directory to a plain widget stub.
    */
    'widget_plain_stub'  => 'vendor/arrilot/laravel-widget/src/Console/stubs/widget_plain.stub',
];
