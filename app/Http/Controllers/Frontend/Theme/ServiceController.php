        ...
        if (AuthCustom::check()) {
            ...
            if (isset($result_Api) && $result_Api->httpcode == 200 && isset($result_Api_telecome) && $result_Api_telecome->httpcode == 200) {
                ...
                if ($result->status == 1) {
                    ...
                    return view('frontend.'.theme('')->theme_key.'.pages.service.getBuyServiceHistory')
        ...
        if ($request->ajax()) {
            ...
            if (isset($result_Api) && $result_Api->httpcode == 200) {
                ...
                if ($result->status == 1) {
                    ...
                    return view('frontend.'.theme('')->theme_key.'.pages.service.function.__get__buy__service__history')
                        ->with('data', $data);
                } else {
                    return redirect()->back()->withErrors($result->message);
                }
