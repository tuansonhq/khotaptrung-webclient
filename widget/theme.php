...
View::composer('frontend.'.theme('')->theme_key.'.widget.__slider__banner', function ($view) {
...
View::composer('frontend.'.theme('')->theme_key.'.widget.__content__home', function ($view) {
...
View::composer('frontend.'.theme('')->theme_key.'.widget.__menu_category_desktop', function ($view) {
...
View::composer('frontend.'.theme('')->theme_key.'.widget.__menu_category_mobile', function ($view) {
...
View::composer('frontend.'.theme('')->theme_key.'.widget.__menu_profile', function ($view) {
...
View::composer('frontend.'.theme('')->theme_key.'.widget.__menu_transaction', function ($view) {
...
View::composer('frontend.'.theme('')->theme_key.'.widget.__menu__category__article', function ($view) {
...
View::composer('frontend.'.theme('')->theme_key.'.widget.__top_nap_the', function ($view) {
    return $view;
});

View::composer('frontend.'.theme('')->theme_key.'.widget.__nap_the', function ($view) {
    return $view;
});

//View::composer('frontend.'.theme('')->theme_key.'.widget.__charge', function ($view) {
...
//
//                if ($result->status == 1) {
//                    return view('frontend.'.theme('')->theme_key.'.pages.index', compact('result'));
//                }
//                else {
