...
//                ablcccccccccccccccccccccccc
    $command='cd /home/frontenra1d/frontend.dev.tichhop.pro/public_html && git pull https://'.config('git.git_secret').'@github.com/tannm2611/khotaptrung-webclient.git '.config('git.git_branch');
