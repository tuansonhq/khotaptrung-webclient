                ...
                @if($item->status == 0)
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="purchased-item mb-4">
                            <div class="mb-2 item-meta small text-storecard">
                            ...
                            <div class="item-content">
                                <div class="inner">
                                    ...
                                    <div class="mb-2">
                                        <label class="mb-1 text-storecard">Mã Pin</label>
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-text bg-transparent text-storecard"><i class="fa fa-copy" style="cursor: pointer" data-id=""></i></span>
                                        </div>
                                    </div>
                                    <div class="mb-2 d-flex justify-content-between">
                                        <div class="text-storecard">Trạng thái</div>
                                        <div>
                                            <b class="text-danger">Thất bại</b>
                                        </div>
                                    </div>
                                    <div class="mb-2 d-flex justify-content-between">
                                        <div class="text-storecard">Mệnh giá</div>
                                        <div>
                                    ...
                                    <div class="inner">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-text bg-transparent text-storecard"><i class="fa fa-copy" style="cursor: pointer" data-id="{{  App\Library\Helpers::Decrypt($itemCard->pin,config('module.charge.key_encrypt')) }}"></i></span>
                                            </div>
                                        </div>
                                        <div class="mb-2 d-flex justify-content-between">
                                            <div class="text-storecard">Số seri</div>
                                            <div>
