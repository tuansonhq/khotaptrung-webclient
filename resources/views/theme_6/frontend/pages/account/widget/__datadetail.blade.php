                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    @if($data_category->slug == 'nick-lien-minh')
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-danger" style="font-weight: 700">{{ $total_tuong }}</td>
                                                        </tr>

                                                        <tr>
                                                            <td style="width:50%">Trang phục:</td>
                                                            <td class="text-danger" style="font-weight: 700">{{ $total_trangphuc }}</td>
                                                        </tr>

                                                        <tr>
                                                            <td style="width:50%">Linh thú TFT:</td>
                                                            <td class="text-danger" style="font-weight: 700">{{ $total_linhthu }}</td>
                                                        </tr>
                                                    ...
                                                    @elseif($data_category->slug == 'nick-ninja-school')
                                                        ...
                                                        @if(isset($server))
                                                            <tr>
                                                                ...
                                                                <td class="text-danger" style="font-weight: 700">{{ $server??null }}</td>
                                                            </tr>
                                                        @endif
                                                        @if(isset($info) && count($info))
                                                            @foreach($info as $ke => $in)
