...
@section('content')
    ...
    <input type="hidden" name="slug_category" class="slug_category" value="{{ $category->slug }}">
    <div class="c-layout-page">
                ...
                <div class="row">
                    <div class="col-lg-10 col-md-12 fixcssacount">
                        <ul class="news_breadcrumbs_theme news_breadcrumbs_theme__show">
                            ...
                            <li>/</li>
                            <li class="news_breadcrumbs_theme__li"><a href="javascript:void(0)" class="news_breadcrumbs_theme_title_a"><p class="news_breadcrumbs_theme_title">{{ $category->title }}</p></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="c-content-box c-size-lg c-overflow-hide c-bg-white font-roboto">
            ...
            <div class="text-center showcontent">
                <h1 style="font-size: 30px;font-weight: bold;text-transform: uppercase">DỊCH VỤ {{ $category->title }}</h1>

            </div>

            {{--            Tính toán  --}}

            <form method="POST" action="/dich-vu/{{ $category->id }}/purchase" accept-charset="UTF-8" class="purchaseForm" enctype="multipart/form-data">
                @csrf
                                        ...
                                        <div class="col-md-12">
                                            <div class="news_image">
                                                @if(isset($data->image))
                                                    ...
                                                    <img src="{{\App\Library\MediaHelpers::media($category->image)}}" alt="{{ $category->title }}">
                                                @else
                                                    <img src="https://nick.vn/storage/images/nfjY80CaXR_1623228739.jpg" alt="{{ $category->title }}">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row__face">
                                        <p style="margin-top: 15px" class="bb"><i class="fas fa-calendar-check" aria-hidden="true"></i> {{ $category->title }}</p>
                                    </div>
                                </div>
                                <div class="col-md-7">
                                    {{--                                    Kiểm tra máy chủ     --}}
