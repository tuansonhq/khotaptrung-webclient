...
{{--    Thêm  js  --}}
    ...
    <script src="/assets/frontend/theme_4/lib/steps/jquery-steps.js"></script>
    <script src="/assets/frontend/theme_4/lib/easeJquery/easing.js?v={{time()}}"></script>
</head>
<body>
            ...
            <fieldset id="fieldset-two">
                ...
                <section>
                    <div class="container banner-mobile-container-ct">
                        <div class="row marginauto banner-mobile-row-ct">
                            <div class="col-auto left-right" style="width: 10%">
                                <img class="lazy previous-step-one" src="/assets/frontend/theme_4/images/cay-thue/back.png" alt="" >
                            </div>
