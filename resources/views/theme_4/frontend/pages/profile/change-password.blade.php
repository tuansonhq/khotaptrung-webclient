            ...
            <div class="col-12 col-md-8 col-lg-9 site-form " style="min-height: 212.568px;">
                <div class="menu-content">
                    ...
                    <div class="wapper profile">
                        ...
                        <form method="POST" action="https://napgamegiare.net/user/change-password" accept-charset="UTF-8" class="form-horizontal form-charge"><input name="_token" type="hidden" value="1d1UtKProIOHCYvd7GjOQ1mwzvuWei6FP3awwoKP">
