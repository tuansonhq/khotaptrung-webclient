<div class="modal fade login show default-Modal" id="successChargeAtmModal" aria-modal="true">
            ...
            <div class="modal-header modal-header-success-ct">
                <div class="row marginauto modal-header-success-row-ct justify-content-center">
                    <div class="col-md-12 text-center">
                        <span>Tạo lệnh nạp ATM thành công</span>
            ...
            <div class="modal-body modal-body-success-ct">
                ...
                <div class="row marginauto modal-body-span-success-ct justify-content-center">
                    <div class="col-md-12 text-center" style="font-size: 14px">
                        Sau khi chuyển khoản thành công hệ thống sẽ xử lí từ 2 giây tới 2 phút và cộng tiền vào tài khoản của bạn. Nếu sai thông tin hoặc xảy ra lỗi, vui lòng liên hệ <span style="color: var(--primary-color);font-weight: 400;font-size: 14px"> fanpage </span> để được hỗ trợ.                                </div>
