...
@section('content')
                                            ...
                                            <div class="swiper-slide body-detail-ctng-col-ct">
                                                <div class="row marginauto hover-overlay-ct">
                                                    <div class="col-md-12 left-right default-overlay-ct">
                                                        <a href="">
                                                            <img class="lazy" src="/assets/frontend/{{theme('')->theme_key}}/image/cay-thue/lienquan.png" alt="">
                                                        </a>
                                                    </div>
    ...
    <div class="media-mobile" id="mobile-caythue">
        ...
        <form id="formBookingStepMobie" action="" method="POST">
            ...
            <fieldset id="fieldset-one">
                                    ...
                                    <div class="row marginauto body-row-napgame-ct">
                                            ...
                                            <div class="row body-title-detail-ct">
                                                ...
                                                <div class="col-md-12 text-left body-title-detail-col-ct">
                                                    <div class="row marginauto password-mobile">
                                                        ...
                                                        <div class="col-md-12 left-right body-title-detail-select-ct" style="position: relative">
                                                            <input autocomplete="off" id="password-mobile" class="input-defautf-ct" type="password" placeholder="Nhập mật khẩu tài khoản Garena">
                                                            <div class="show-btn-password-mobile">
                                                                <img class="lazy" src="/assets/frontend/{{theme('')->theme_key}}/image/cay-thue/eyehide.png" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-12 left-right">
                                            <div class="row body-title-detail-ct">
                                                ...
                                                <div class="col-auto text-left body-title-detail-col-center-ng-ct">
                                                    <div class="row marginauto password-mobile-napgame capcha-image-bg">
                                                        <div class="col-md-12 left-right body-title-detail-select-ct">
                                                            <img class="lazy" src="/assets/frontend/{{theme('')->theme_key}}/image/cay-thue/capcha.png" alt="">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-12 left-right body-title-ct">
                                            <div class="row marginauto">
                                                <div class="col-md-12 text-left left-right">
                                                    <button class="button-default-ct button-next-step-one" type="button">Thanh toán</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <input type="hidden" name="next" class="input-next-step-one"  value="Tiếp theo"/>
            ...
            <fieldset id="fieldset-two">
                ...
                <section>
                    <div class="row marginauto" style="padding: 12px 16px">
                        ...
                        <div class="col-md-12 left-right padding-order-footer-mobile-ct">
                            <div class="row marginauto">
                                <div class="col-md-12 left-right">
                ...
                <div class="modal-header modal-header-success-ct">
                    <div class="row marginauto modal-header-success-row-ct text-center">
                        <div class="col-md-12 text-center" style="position: relative">
                            ...
                            <img class="lazy img-close-ct" src="/assets/frontend/{{theme('')->theme_key}}/image/cay-thue/close.png" alt="">
                        </div>
                    </div>
                </div>
