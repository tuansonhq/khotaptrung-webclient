                ...
                <div class="row marginauto body-container-row-ct body-container-row-mobile-ct">
                    <div class="col-lg-5 col-12 body-container-detail-left-ct">
                        <form action="" method="POST">
                            @csrf
                            <div class="row marginauto body-row-ct web-media-ct">
                                                        ...
                                                        <div class="col-auto body-title-detail-checkbox-col-ct">
                                                            <label for="tuychon-01" class="input-ratio-ct">
                                                                <ul>
                                                                    ...
                                                                    <li class="checkbox-info-ct"><img class="lazy" src="/assets/frontend/{{theme('')->theme_key}}/image/cay-thue/infor.png" alt=""></li>
                                                                </ul>
                                        ...
                                        <div class="col-md-12 text-left left-right">
                                            ...
                                            <span>
                                                <ul>
                                                    ...
                                                    <li class="option-info-ct"><img class="lazy" src="/assets/frontend/{{theme('')->theme_key}}/image/cay-thue/infor.png" alt=""></li>
                                                </ul>
                                            </span>
                                                </div>
                                                <div class="col-md-12 left-right body-title-detail-select-ct">
                    ...
                    <div class="col-lg-7 col-12 body-container-detail-right-ct">
                        ...
                        <div class="row marginauto intermediary-ct">
                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="row marginauto body-row-ct web-media-ct">
                                            ...
                                            <div class="row body-title-detail-ct">
                                                ...
                                                <div class="col-md-6 text-left body-title-detail-col-ct">
                                                    <div class="row marginauto password-mobile">
                                                        ...
                                                        <div class="col-md-12 left-right body-title-detail-select-ct" style="position: relative">
                                                            <input autocomplete="off" id="password-mobile" class="input-defautf-ct" type="password" placeholder="Nhập mật khẩu trong game">
                                        ...
                                        <div class="col-md-12 left-right body-title-ct">
                                            <div class="row marginauto">
                                                <div class="col-md-12 text-left left-right">
                                                    <button class="button-default-ct button-next-step-one" type="button">Thuê ngay</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
