...
{{-- @dd($data) --}}
    <div class="col-lg-4 px-0 mb-2 mb-lg-0 d-none d-lg-block">
                        ...
                        <a href="/tin-tuc">
                            <div class="row marginauto">
                                <div class="col-auto left-right">
                                    <i class="__icon --md --path__custom" style="--path : url(png/assets/frontend/{{theme('')->theme_key}}/image/icons/cat-news-all.)"></i>
                                </div>
