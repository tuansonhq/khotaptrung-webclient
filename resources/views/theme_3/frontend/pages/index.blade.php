            ...
            <div class="box-list-service d-g-lg-none">
                ...
                <ul class="list-service">
                    <li class="item-service">
                        <a href="">
                            <img src="/assets/frontend/{{theme('')->theme_key}}/image/service_home.svg" alt="">
                            <div>Nạp thẻ cào</div>
                        </a>
                    ...
                    <li class="item-service">
                        <a href="">
                            <img src="/assets/frontend/{{theme('')->theme_key}}/image/service_home2.svg" alt="">
                            <div>Nạp ATM- VÍ</div>
                        </a>
                    ...
                    <li class="item-service">
                        <a href="">
                            <img src="/assets/frontend/{{theme('')->theme_key}}/image/service_home3.svg" alt="">
                    ...
                    <li class="item-service">
                        <a href="/mua-acc">
                            <img src="/assets/frontend/{{theme('')->theme_key}}/image/service_home4.svg" alt="">
                    ...
                    <li class="item-service">
                        <a href="/dich-vu">
                            <img src="/assets/frontend/{{theme('')->theme_key}}/image/service_home5.svg" alt="">
                    ...
                    <li class="item-service">
                        <a href="/minigame">
                            <img src="/assets/frontend/{{theme('')->theme_key}}/image/service_home6.svg" alt="">
                            <div>Vòng quay</div>
                        </a>
                    ...
                    <li class="item-service">
                        <a href="/recharge-game">
                            <img src="/assets/frontend/{{theme('')->theme_key}}/image/service_home7.svg" alt="">
                    ...
                    <li class="item-service">
                        <a href="">
                            <img src="/assets/frontend/{{theme('')->theme_key}}/image/service_home8.svg" alt="">
                            <div>Mua thẻ game</div>
                        </a>
                    </li>
    ...
    <div class="block-product mt-fix-20 d-none d-g-md-block">
        ...
        <div class="box-product">
            <div class=" d-flex justify-content-lg-between row" >
                ...
                <div class="item-product item-product-service col-lg-auto col-md-3 col-4 mb-fix-16">
                    <a href="/nap-the">
                        <img src="/assets/frontend/{{theme('')->theme_key}}/image/service_significant8.png" alt="">
                        <div>Nạp ATM -Ví</div>
                    </a>
                </div>
    ...
    <div class="block-mini-game mt-fix-20">
        <div class="row">
            <div class="col-lg-8 col-md-12 pr-md-0" >
                <div class=" block-product ">
                    <div class="product-header d-flex">
                        ...
                        <p class="text-title" >Vòng quay</p>
                        <div class="navbar-spacer"></div>
                    ...
                    <div class="box-product " >
                        <div class="row list-product list-minigame" >
                            ...
                            <div class="list-minigame_box-left col-md-6 pr-fix-8 pl-fix-8">
                                <div class="item-minigame_first ">
                                    <a href="/minigame/slug">
                                        <img src="/assets/frontend/{{theme('')->theme_key}}/image/minigame_first.png" alt="">
                                        <div class="item-minigame-content">
                                            <div class="item-minigame-name">Hũ Vàng, Hũ Bạc</div>
                                            <div class="item-minigame-amount">3.456.789.123 đ</div>
                                            <div class="item-minigame-view">
                                                <img src="/assets/frontend/{{theme('')->theme_key}}/image/view_eyes.png" alt=""> <span>232</span>  <img src="/assets/frontend/{{theme('')->theme_key}}/image/view_video.png" alt=""> <span>123456</span>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="row">
                                    <div class="col-md-6 pr-fix-8 pl-fix-8 ">
                                        <div class="item-minigame_second">
                                            <a href="/minigame/slug">
                                                <img src="/assets/frontend/{{theme('')->theme_key}}/image/minigame_second.png" alt="">
                                                <div class="item-minigame-content">
                                                    <div class="item-minigame-name">Hũ Vàng, Hũ Bạc</div>
                                                    <div class="item-minigame-amount">3.456.789.123 đ</div>
                                                    <div class="item-minigame-view">
            ...
            <div class="col-lg-4 col-md-12  " >
                <div class=" top-list ">
                    <p><img src="/assets/frontend/{{theme('')->theme_key}}/image/star_top.png" alt=""> Top chơi mini game</p>
