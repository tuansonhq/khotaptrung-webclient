                        ...
                        <div class="row marginauto nav-bar-nick nav-bar-child add-active_withdraw-items">
                            <div class="col-12 left-right">
                                <a href="">
                                    <div class="row marginauto">
                                        <div class="col-auto left-right">
                                            <i class="__icon --md --path__custom" style="--path : url(/assets/frontend/{{theme('')->theme_key}}/image/icons/cat-news-guide.png)"></i>
                                        </div>
                                        <div class="col-10 nav-bar-log-top-body-col">
                                            <span>Hướng dẫn</span>
                                        </div>
                        ...
                        <div class="row marginauto nav-bar-nick nav-bar-child add-active_withdraw-items">
                            <div class="col-12 left-right">
                                <a href="">
                                    <div class="row marginauto">
                                        <div class="col-auto left-right">
                                            <i class="__icon --md --path__custom" style="--path : url(/assets/frontend/{{theme('')->theme_key}}/image/icons/cat-news-about.png)"></i>
                                        </div>
                                        <div class="col-10 nav-bar-log-top-body-col">
