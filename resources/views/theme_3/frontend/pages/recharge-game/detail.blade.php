...
@section('content')
    ...
    <form id="formBookingStepMobie" action="" method="POST">
        ...
        <fieldset id="fieldset-one">
            <section class="media-web">
                <div class="container container-fix menu-container-ct">
                    <ul>
                        ...
                        <li class="menu-container-li-ct"><img class="lazy" src="/assets/frontend/{{theme('')->theme_key}}/image/cay-thue/arrow-right.png" alt=""></li>
                        <li class="menu-container-li-ct"><a href="/recharge-game/slug">Liên minh huyền thoại</a></li>
                    </ul>
                </div>
            </section>
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="row marginauto body-row-napgame-ct">
                                    ...
                                    <div class="col-md-12 left-right">
                                        <div class="row marginauto banner-container-ct">
                                            <div class="col-md-12 text-left left-right">
                                                <img class="lazy" src="/assets/frontend/{{theme('')->theme_key}}/image/cay-thue/ctnapgame-bg.png" alt="">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-12 text-left body-title-detail-col-ct">
                                                <div class="row marginauto">
                                                    ...
                                                    <div class="col-md-12 left-right body-title-detail-select-ct">
                                                        <input autocomplete="off" name="amount" class="input-defautf-ct amount" type="text" placeholder="Gói 3:80 RP">
                                                    </div>
                                                    <div class="col-md-12 left-right rp-errorr">
                                        ...
                                        <div class="row body-title-detail-ct">
                                            <div class="col-md-12 text-left body-title-detail-col-ct">
                                                <div class="row marginauto">
                                                    ...
                                                    <div class="col-md-12 left-right body-title-detail-select-ct">
                                                        <input autocomplete="off" class="input-defautf-ct username" name="username" type="text" placeholder="Nhập Tên tài khoản Garena">
                                                    </div>
                                            ...
                                            <div class="col-md-12 text-left body-title-detail-col-ct">
                                                <div class="row marginauto password-mobile">
                                                    ...
                                                    <div class="col-md-12 left-right body-title-detail-select-ct" style="position: relative">
                                                        <input autocomplete="off" id="password" name="password" class="input-defautf-ct password" type="password" placeholder="Nhập mật khẩu tài khoản Garena">
                                                        <div class="show-btn-password">
                                                            <img class="lazy" src="/assets/frontend/{{theme('')->theme_key}}/image/cay-thue/eyehide.png" alt="">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-12 left-right">
                                        <div class="row body-title-detail-ct">
                                            ...
                                            <div class="col-auto text-left body-title-detail-col-left-ng-ct">
                                                <div class="row marginauto">
                                                    <div class="col-md-12 left-right body-title-detail-select-ct">
                                                        <input autocomplete="off" class="input-defautf-ct capcha" name="capcha" type="text" placeholder="Nhập mã bảo vệ">
                                                    </div>
                                                    <div class="col-md-12 left-right cc-error">
                                            ...
                                            <div class="col-auto text-left body-title-detail-col-center-ng-ct">
                                                <div class="row marginauto capcha-image-bg">
                                                    <div class="col-md-12 left-right body-title-detail-select-ct">
                                    ...
                                    <div class="col-md-12 left-right body-title-ct">
                                        <div class="row marginauto">
                                            <div class="col-md-12 text-left left-right">
                                                <button class="button-default-ct btn-data media-web" type="button">Thanh toán</button>
                            ...
                            <div class="row marginauto body-detail-header-right-ct media-web">
                                ...
                                <div class="col-md-12 left-right">
                                    <div class="row banner-detail-ct">
                                        <div class="col-md-12 text-left left-right">
                                            <img class="lazy" src="/assets/frontend/{{theme('')->theme_key}}/image/cay-thue/magianpgame.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            {{--                block 2           --}}
                            <div class="row marginauto body-detail-right-ng-ct detailViewBlock">

                                <div class="col-md-12 left-right">
                                    <div class="row marginauto">
                                        <div class="col-md-12 col-8 body-header-col-km-left-ct">
                                            <small class="detailViewBlockTitle">Mô tả</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 left-right">
                                    <div class="row marginauto body-title-ct show-detail-napgame-ct">
                                        <div class="col-md-12 text-left left-right content-video-in content-video-in-add detailViewBlockContent">
                        ...
                        <div class="modal-body modal-body-order-ct">
                            <div class="row marginauto">
                                ...
                                <div class="col-md-12 left-right padding-order-footer-ct">
                                    <div class="row marginauto">
                                        <div class="col-md-12 left-right">
                                            <button class="button-default-ct btn-success-data openSuccess" type="button">Xác nhận</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            @include('frontend.pages.recharge-game.widget.__related')
        </fieldset>
                    ...
                    <div class="row marginauto justify-content-center modal-footer-success-ct">
                        ...
                        <div class="col-md-6 col-6 modal-footer-success-col-right-ct">
                            <div class="row marginauto modal-footer-success-row-ct">
                                <div class="col-md-12 left-right">
                                    <a href="/" class="button-bg-ct close-modal-default"><span>Nạp thêm</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="/assets/frontend/{{theme('')->theme_key}}/js/nap-game/nap-game-detail.js"></script>
@endsection
