    ...
    <div class="container container-fix">
        ...
        <div class="block-mini-game ">
            <div class="row">
                    ...
                    <div class=" block-product ">
                        <div class="product-header d-flex">
                            ...
                            <div class="minigame-button-swiper d-flex d-g-md-none">
                                <div class="swiper-button-next"><img src="/assets/frontend/{{theme('')->theme_key}}/image/swiper_prev.png" alt=""></div>
                                <div class="swiper-button-prev"> <img src="/assets/frontend/{{theme('')->theme_key}}/image/swiper_next.png" alt=""></div>
                                        ...
                                        <div class="row">
                                            <div class="list-minigame_box-left col-md-6 pr-fix-8 ">
                                                <div class="item-minigame_first">
                                                    <a href="">
                                                        <img src="/assets/frontend/{{theme('')->theme_key}}/image/minigame_first_detail.png" alt="">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 pr-fix-8 pl-fix-8 ">
                                                        <div class="item-minigame_second">
                                                            <a href="">
                                                                <img src="/assets/frontend/{{theme('')->theme_key}}/image/minigame_second_detail.png" alt="">
                                                                <div class="item-minigame-content">
                                                                    <div class="item-minigame-name_detail">Vòng quay Freefire</div>
                                                                    <div class="item-minigame-user">123.456.789 đã chơi</div>
                                                                    <div class="item-minigame-amount">
                                                            ...
                                                            <div class="item-minigame-top">
                                                                <img src="/assets/frontend/{{theme('')->theme_key}}/image/minigame_top.png" alt=""> <div>Top 2</div>
                ...
                <div class="col-lg-4 col-md-12  " >
                    <div class=" top-list ">
                        <p><img src="/assets/frontend/{{theme('')->theme_key}}/image/star_top.png" alt=""> Top lượt quay</p>
        ...
        <div class=" block-product mt-fix-20">
            <div class="product-header d-flex">
                ...
                <div class="text-view-more">
                    <a href="/recharge-game" class="global__link">Xem thêm<i class="__icon --sm --link ml-1" style="--path : url(/assets/frontend/{{theme('')->theme_key}}/image/icons/arrow-right-blue.png)"></i></a>
                </div>
            </div>
