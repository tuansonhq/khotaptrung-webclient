                ...
                <div class=" mb-4">
                    <div class="" id="history" style="min-height: 628px;">
                            <div class="d-flex justify-content-between align-items-md-center flex-column flex-md-row">
                                <h4 class="title-style-left mb-3">Dịch vụ đã mua</h4>
                        ...
                        @if(isset($data->itemconfig_ref->params))
                            ...
                            <div class="block-content">
                                <div class="history-detail-content brs-12 mx-auto">
        ...
        <div class="modal-dialog modal-dialog-centered modal-custom">
            <form method="POST" id="chatFrom" enctype="multipart/form-data" action="/inbox/send/{{$data->id}}" accept-charset="UTF-8" class="form-horizontal form-charge">
                ...
                <div class="modal-content c-p-24">
                    ...
                    <div class="modal-body c-px-0 c-pt-12 c-pb-24">
                        <div class="c-mt-12">
                            <label class="c-mb-4 fw-500 fz-13 lh-20">Nội dung</label>
                            <div class="col-md-12 p-0">
                        ...
                        <div class="c-mt-12">
                            ...
                            <div class="col-md-12 p-0 d-flex">
                                ...
                                <button class="refresh-captcha brs-8" id="reload">
                                    <img  src="/assets/frontend/{{theme('')->theme_key}}/image/refresh_captcha.png" alt="">
                                </button>
