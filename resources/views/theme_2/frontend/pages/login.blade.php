                            ...
                            <form action="{{route('login')}}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="login_username" name="username" class="form-control border-end-0" placeholder="+84" value="" autocomplete="off">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="password" id="login_password" name="password" class="form-control border-end-0" placeholder="" value=""  autocomplete="off">
...
{{--                                <p>Không nhớ mất khẩu? <a href="#" class="forgot-link" data-bs-toggle="modal" data-bs-target="#forgotModal">Lấy lại mật khẩu</a></p>--}}
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        <a href="#" class="btn btn-outline-primary text-primary d-block btn-login"><i class="lab la-facebook"></i> Facebook</a>
                                    </div>
                                    <div class="col-6">
                ...
                <div class="p-4 bg-light h-100">
                    <form action="#" method="post">
                        ...
                        <div class="mb-3">
                            <label class="label mb-1">Tên tài khoản</label>
                            <div class="input-group">
                                <input type="text" id="username" name="username" class="form-control border-end-0" placeholder="" value=""  autocomplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" id="phone" name="phone" class="form-control border-end-0" placeholder="" value=""  autocomplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" id="enmail" name="enmail" class="form-control border-end-0" placeholder="" value="" autocomplete="off">
