...
@endsection
@section('scripts')
    <script src="/assets/frontend/{{theme('')->theme_key}}/js/config/form-validate.js?v={{time()}}"></script>
@endsection
@section('meta_robots')
                    ...
                    <div class="card-body c-px-16 c-px-lg-0 c-py-0">
                        <div class="c-pt-16 c-pb-lg-50 c-mb-lg-50" id="tab-1" role="tabpanel">
                            ...
                            <div class="input-group">
                                ...
                                <div class="toggle-password">
                                    <input class="password" name="password-new" type="password" placeholder="Vui lòng nhập mật khẩu mới">
                                </div>
                                <span class="text-error"></span>
                            </div>
                            ...
                            <div class="footer-mobile v2 group-btn c-my-24 c-my-lg-0 c-px-lg-16 c-pt-lg-16 button-password" style="--data-between:12px">
                                <button class="btn primary btn-data" type="submit">Đổi mật khẩu</button>
                            </div>
                            </form>
                        </div>
                    </div>
