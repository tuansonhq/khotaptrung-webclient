<div class="sidebar">
    ...
    <div class="sidebar-section brs-12 c-mb-16">
        <div class="sidebar-item">
            <a href="/thong-tin" class="d-block align-items-center d-flex">
                <div class="icon-sidebar" style="--path:url(/assets/frontend/{{theme('')->theme_key}}/image/svg/sidebar-bien-dong-so-du.svg)"></div>
        ...
        <div class="sidebar-item">
            <a href="/changepassword" class="d-block align-items-center d-flex">
                <div class="icon-sidebar" style="--path:url(/assets/frontend/{{theme('')->theme_key}}/image/svg/sidebar-the-cao-da-mua.svg)"></div>
    ...
    <div class="sidebar-section brs-12 c-mb-16">
        ...
        <div class="d-flex justify-content-between transaction-manager">
            <div class="sidebar-item sidebar-item-col active">
                <a href="/lich-su-giao-dich" class=" d-flex flex-column align-items-center">
                    <div class="icon-sidebar" style="--path:url(/assets/frontend/{{theme('')->theme_key}}/image/svg/sidebar-the-cao-da-mua.svg)"></div>
            ...
            <div class="sidebar-item sidebar-item-col">
                <a href="/withdrawitem-slug" class=" d-flex flex-column align-items-center">
                    <div class="icon-sidebar" style="--path:url(/assets/frontend/{{theme('')->theme_key}}/image/svg/sidebar-the-cao-da-mua.svg)"></div>
    ...
    <div class="sidebar-section brs-12 c-mb-16">
        ...
        <div class="sidebar-item-partition d-flex c-my-8"></div>
        <div class="sidebar-item">
            <a href="/the-cao-da-mua" class="d-block align-items-center d-flex">
                <div class="icon-sidebar" style="--path:url(/assets/frontend/{{theme('')->theme_key}}/image/svg/sidebar-the-cao-da-mua.svg)"></div>
        ...
        <div class="sidebar-item-partition d-flex c-my-8"></div>
        <div class="sidebar-item">
            <a href="/minigame-log-id" class="d-block align-items-center d-flex">
                <div class="icon-sidebar" style="--path:url(/assets/frontend/{{theme('')->theme_key}}/image/svg/sidebar-the-cao-da-mua.svg)"></div>
        ...
        <div class="sidebar-item-partition d-flex c-my-8"></div>
        <div class="sidebar-item">
            <a href="/lich-su-mua-nick" class="d-block align-items-center d-flex">
                <div class="icon-sidebar" style="--path:url(/assets/frontend/{{theme('')->theme_key}}/image/svg/sidebar-the-cao-da-mua.svg)"></div>
        ...
        <div class="sidebar-item-partition d-flex c-my-8"></div>
        <div class="sidebar-item">
            <a href="/lich-su-tra-gop" class="d-block align-items-center d-flex">
                <div class="icon-sidebar" style="--path:url(/assets/frontend/{{theme('')->theme_key}}/image/svg/sidebar-the-cao-da-mua.svg)"></div>
