            ...
            @else
                <div class="sidebar-section brs-12 c-mb-16">
                    ...
                    @forelse($menu[$item->id] as $key => $menu_child)
                        ...
                        <div class="sidebar-item {{ $menu_child->url ? '/'.request()->path() == $menu_child->url || str_contains('/'.request()->path(), $menu_child->url) ? 'active' : '' : '/'.request()->path() == $menu_child->slug || str_contains('/'.request()->path(),$menu_child->slug ) ? 'active' : '' }}">
