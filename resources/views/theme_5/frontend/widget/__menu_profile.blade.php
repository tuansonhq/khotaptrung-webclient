<div class="sidebar">
    <div class="sidebar-section d-flex brs-12 c-mb-16">
        ...
        <div class="sidebar-section-info">
            <p class="sidebar-section-title c-mb-4 fz-15 fw-500 account-name-sidebar" ></p>
            <p class="sidebar-section-info-text c-mb-4 fz-13 fw-500 account-balance-sidebar" ></p>
            {{--                <p class="sidebar-section-info-text c-mb-4 fz-13 fw-500">Xu khóa: <span>100.000 xu</span></p>--}}
            <p class="sidebar-section-info-text mb-0 fz-13 fw-500 account-id-sidebar"></p>
        </div>
    </div>
