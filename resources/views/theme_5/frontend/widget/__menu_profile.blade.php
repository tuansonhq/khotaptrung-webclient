                    ...
                    <div class="sidebar-item">
                        <a href="/thong-tin" class="d-block align-items-center d-flex">
                            <div class="icon-sidebar"
                                 style="--path:url(/assets/frontend/theme_5/image/svg/sidebar-bien-dong-so-du.svg)"></div>
                            <p class="sidebar-item-text fw-400 fz-12 mb-0">Thông tin tài khoản</p>
                            <img src="/assets/frontend/{{env('THEME_VERSION')}}/image/svg/sidebar_arrow_right.svg"
                                 alt="">
                        </a>
                    </div>
                    ...
                    <div class="d-flex justify-content-between transaction-manager">
                        @if(isset($menu[$item->id]))
                            @forelse($menu[$item->id] as $key => $menu_child)
                                <div class="sidebar-item sidebar-item-col {{ !$key ? 'active' : '' }}">
