...
@elseif(theme('')->theme_config->sys_theme_ver == 'sys_theme_ver3.3')
    <section class="section-category-tab c-mb-20 c-mb-lg-16">
        <div class="section-header c-mb-20 c-mb-lg-16 justify-content-between">
            ...
            <ul class="nav nav-tabs size-auto" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="tab active" data-toggle="tab" href="#tab-1" role="tab" aria-selected="true">Xu khóa </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="tab" data-toggle="tab" href="#tab-2" role="tab" aria-selected="false">Vòng quay</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="tab" data-toggle="tab" href="#tab-3" role="tab" aria-selected="false">Mini game khác</a>
                </li>
            </ul>
            <a href="" class="link arr-right d-none d-lg-block">Xem tất cả</a>
        </div>
