                    ...
                    <div class="card">
                        <a href="/minigame-slug" class="card-body scale-thumb c-p-16 c-p-lg-12">
                            <div class="account-thumb c-mb-8">
                                <img src="/assets/frontend/{{theme('')->theme_key}}/image/son/vongquay01.png" alt="" class="account-thumb-image">
                            </div>
            ...
            <div class="swiper-slide">
                <div class="item-category">
                    <div class="card">
                        <a href="/minigame-slug" class="card-body scale-thumb c-p-16 c-p-lg-12">
                            <div class="account-thumb c-mb-8">
                                <img src="/assets/frontend/{{theme('')->theme_key}}/image/son/vongquay02.png" alt="" class="account-thumb-image">
                            </div>
                            <div class="account-title">
                                <div class="text-title fw-700 text-limit limit-1">Nick Freefire random....</div>
                            </div>
            ...
            <div class="swiper-slide">
                <div class="item-category">
                    <div class="card">
                        <a href="/minigame-slug" class="card-body scale-thumb c-p-16 c-p-lg-12">
                            <div class="account-thumb c-mb-8">
                                <img src="/assets/frontend/{{theme('')->theme_key}}/image/son/vongquay03.png" alt="" class="account-thumb-image">
                            </div>
                            <div class="account-title">
                                <div class="text-title fw-700 text-limit limit-1">Nick Freefire random....</div>
                            </div>
            ...
            <div class="swiper-slide">
                <div class="item-category">
                    <div class="card">
                        <a href="/minigame-slug" class="card-body scale-thumb c-p-16 c-p-lg-12">
                            <div class="account-thumb c-mb-8">
                                <img src="/assets/frontend/{{theme('')->theme_key}}/image/son/vongquay04.png" alt="" class="account-thumb-image">
                            </div>
                            <div class="account-title">
                                <div class="text-title fw-700 text-limit limit-1">Nick Freefire random....</div>
                            </div>
            ...
            <div class="swiper-slide">
                <div class="item-category">
                    <div class="card">
                        <a href="/minigame-slug" class="card-body scale-thumb c-p-16 c-p-lg-12">
                            <div class="account-thumb c-mb-8">
                                <img src="/assets/frontend/{{theme('')->theme_key}}/image/son/vongquay05.png" alt="" class="account-thumb-image">
                            </div>
                            <div class="account-title">
                                <div class="text-title fw-700 text-limit limit-1">Nick Freefire random....</div>
                            </div>
