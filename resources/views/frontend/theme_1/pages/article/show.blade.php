        ...
        <div class="news_content">
            <div class="container">
                <div class="row">
                    ...
                    @include('frontend.'.theme('')->theme_key.'.widget.__menu__category__article',with(['slug'=>$data->slug]))

                </div>
            </div>
        </div>

        @include('frontend.'.theme('')->theme_key.'.pages.article.bai__viet__lien__quan')
