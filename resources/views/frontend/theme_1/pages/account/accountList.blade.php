...
@section('seo_head')
    @include('frontend.'.theme('')->theme_key.'.widget.__seo_head',with(['data'=>$data]))
@endsection
@section('content')
...
{{--                                {{Form::select('status',array(''=>'-- Chọn giá tiền --')+config('module.acc.status'),old('status', isset($data['status']) ? $data['status'] : null),array('class'=>'form-control status'))}}--}}
                        ...
                        @include('frontend.'.theme('')->theme_key.'.pages.account.widget.account_load_attribute_to_filter',['dataAttribute'=>$dataAttribute])
...
{{--                                            <option value="2">Đã đặt cọc</option>--}}
                                ...
                                @include('frontend.'.theme('')->theme_key.'.pages.account.widget.account_load_attribute_to_filter_mobile',['dataAttribute'=>$dataAttribute])
...
{{--                                                            <option value="">Tất cả</option>--}}
            ...
            <div id="account_data">
                @include('frontend.'.theme('')->theme_key.'.pages.account.function.__account__data',['dataAttribute'=>$dataAttribute])
            </div>
