...
@section('seo_head')
    @include('frontend.'.theme('')->theme_key.'.widget.__seo_head')
@endsection
@push('style')
@endpush
@push('js')
...
@section('content')
    <div class="layout-page">
        <div class="content-layout" >
                    ...
                    <div class="tab-content">
                        <div class="tab-pane  fade show active" id="top_napthe">
                            <div class="content-banner-card-box">
                                {!! widget('frontend.'.theme('')->theme_key.'.widget.__top_nap_the',60) !!}

                            </div>
                        </div>
                        <div class="tab-pane  fade show " id="napthe">
                            <div class="content-banner-card-form">
                                {!! widget('frontend.'.theme('')->theme_key.'.widget.__nap_the') !!}
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-12 slider_in" >
                                <div class="swiper-container mySwiper slider_detail">
                                    <div class="swiper-wrapper">
                                        {!! widget('frontend.'.theme('')->theme_key.'.widget.__slider__banner',60) !!}
                                    </div>
            ...
            {!! widget('frontend.'.theme('')->theme_key.'.widget.__content__home',60) !!}
