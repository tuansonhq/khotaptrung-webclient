...
{{--            DỊCH VỤ KHÁC     --}}
{{--        {!! widget('frontend.'.theme('')->theme_key.'.pages.service.widgets.list_service_category',60) !!}--}}
            @include('frontend.'.theme('')->theme_key.'.pages.service.widgets.list_service_category')
