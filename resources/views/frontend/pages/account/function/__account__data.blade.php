                    ...
                    <div class="col-6 col-sm-6 col-lg-3">
                        <div class="item_buy_list_in">
                            <div class="item_buy_list_img">
                                <a href="javascript:void(0)" class="buyacc" data-id="{{ encodeItemID($item->id) }}">
                                    @if(isset($item->image))
                                    ...
                                    <span>MS: {{ encodeItemID($item->id) }}</span>
                                </a>
                            </div>
...
{{--                                            <span>{{ formatPrice($item->price_old) }}đ </span>--}}
                                    ...
                                    <a href="javascript:void(0)" class="col-6 buyacc" data-id="{{ encodeItemID($item->id) }}">
                ...
                @else
                    ...
                    <div class="col-6 col-sm-6 col-lg-3">
                        <div class="item_buy_list_in">
                            <div class="item_buy_list_img">
                                <a href="/acc/{{ encodeItemID($item->id) }}">
                                    @if(isset($item->image))
                                        <img class="item_buy_list_img-main" src="https://media-tt.nick.vn/{{ $item->image }}" alt="{{ $item->title }}">
                                    @else
                                        <img class="item_buy_list_img-main" src="https://shopas.net/storage/images/CGuYto7yjj_1645585924.jpg" alt="{{ $item->title }}">
...
{{--                                    @dd($index)--}}
                            ...
                            <div class="item_buy_list_more">
                                <div class="row">
                                    ...
                                    <a href="/acc/{{ encodeItemID($item->id) }}" class="col-12">
                                        <div class="item_buy_list_view">
                                            Chi tiết
                                        </div>
                                    </a>
