...
<form class="formDonhangAccount" action="/acc/{{ $data->id }}/databuy" method="POST">
    {{ csrf_field() }}
    ...
    {{--            <button type="submit" class="btn c-theme-btn c-btn-square c-btn-uppercase c-btn-bold"  id="d3" style="">Xác nhận mua</button>--}}
                ...
                @else
                    <button type="submit" class="btn c-theme-btn c-btn-square c-btn-uppercase c-btn-bold loginBox__layma__button__displayabs"  id="d3" style="">Xác nhận mua</button>
                @endif
            @endif
        @else
